...
@dp.callback_query_handler(presets_callback.filter(size='50_columns'))
async def default_html(call: CallbackQuery):
    ...
    output = ascii_magic.from_image_file(f'docs/{username}/picture.png',
                                         columns=50, mode=ascii_magic.Modes.HTML)  # Customization for default html doc
